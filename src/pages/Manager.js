    ...
    <>
      <Navbar /> 
        <div className="flex items-center justify-between w-full px-8 py-4 bg-gray-700 text-white">
          ...
          <input type="text" className="ml-auto w-1/3 p-2 rounded-md mr-2" placeholder="Search contacts"/>
          <Link to="/Form" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">
